...
class Game {
    ...
    constructor() {
        ...
        /* eventLister code for method of processing inputs. Not implemented with AI yet */

        /* Event Listerer: Enter button */
        document.getElementById("input").addEventListener('click', () => {
            console.log("Player inputting attack coordinates");
            window.addEventListener('keypress', (event) => {
                if (event.key == 'Enter') {
                    console.log("Enter action used to execute attack")
                    if(i % 2 == 1) {
            ...
            /* Event Listerer: Clicked "confirmInput" button */
            document.getElementById("confirmInput").addEventListener('click', () => {
                console.log("Click action used to execute attack");
                if(i % 2 == 1) {
                    //window.alert("\nIt is " + Player1.m_name + "'s turn! Don't look " + Player2.m_name)
                    Player1.takeATurn(1, document.querySelector('#input').value);
                    alert("\nIt is " + Player2.m_name + "'s turn! Don't look " + Player1.m_name)
